...
1	2	1	Hammer	Some description	$145.00	\N	\N
2	2	2	Compact Dril	Some description	$145.00	\N	\N
\.
...
--
-- Name: order_status_idx; Type: INDEX; Schema: public; Owner: scaly
--
...
--
-- Name: product_name_idx; Type: INDEX; Schema: public; Owner: scaly
--

CREATE INDEX product_name_idx ON public.products USING btree (name);


--
-- Name: product_status_idx; Type: INDEX; Schema: public; Owner: scaly
--

CREATE INDEX product_status_idx ON public.products USING btree (status);
...
--
-- Name: TABLE order_items; Type: ACL; Schema: public; Owner: scaly
--

REVOKE ALL ON TABLE public.order_items FROM scaly;
GRANT SELECT,INSERT,REFERENCES,TRIGGER,TRUNCATE ON TABLE public.order_items TO scaly;
